...
KERNEL_FQ void m01415_mxx (KERN_ATTR_BASIC ())
{
  /**
   * modifier
   */
  ...
  sha256_update_global_swap (&ctx1l, pws[gid].i, pws[gid].pw_len);
  ...
  {
    sha256_ctx_t ctx1 = ctx1l;
    
    sha256_update_global_swap (&ctx1, combs_buf[il_pos].i, combs_buf[il_pos].pw_len);
...
KERNEL_FQ void m01415_sxx (KERN_ATTR_BASIC ())
{
  /**
   * modifier
   */
